        ...
        setup(p) {
                ...
                KB = x((() => {
                    ...
                    const n = Object.keys(e).map((n => {
                            ...
                            const u = e[n],
                                ...
                                v = o.round(p - x, 2),
                                g = {};
                            return g.insBaseCount = c, g.insCurrenyCount = p, g.outBaseCount = m, g.outCurrencyCount = x, g.leftBaseCount = y, g.leftCurrencyCount = v, g.user = n && n.trim() !== "" ? n : "无", g
                        })),
                        l = {};
                    return l.group_content = n, l.group_len = t, l
                })),
            ...
            (async () => {
                if (ve.id) {
                   ...
                   n.params = t;
                   // 首先请求第一个 URL
                   let l = await e.get("https://bot.letsvpn.bet/botWeb/options/", n);
                   // 检查返回的数据是否为空
                   if (!l || l.length === 0) {
                       // 如果为空，则请求第二个 URL
            ...
            const Ee = async () => {
                ...
                const n = {};
                n.params = t;
                let l = await e.get("https://bot.letsvpn.bet/botWeb/bill/", n);
                if (!l || l.length === 0) {
