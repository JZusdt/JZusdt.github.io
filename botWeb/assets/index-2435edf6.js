...
import { d, r as m, c as x, a as y, b as v, w as g, F as f, e as h, u as C, i as k, t as b, f as _, g as w, h as z, n as B, _ as A, o as O, p as T, j as U } from "./index-5026f0d8.js?v=11";
            ...
            const d = !t(),
                ...
                // }, 
                {
                  ...
                  render: e => {
                    ...
                    return v("span", { style: baseStyle }, [null == e.messageid ? "" : e.messageid]);
                  }
                }]),
                M = {
                    tooltip: !0
	            ...
	            (async () => {
                   ...
                   const n = {};
                   n.params = t;
			                   // 主接口优先；异常或返回格式不对时，再请求备用接口。
			                   let l;
			                   try {
			                      l = await e.get("https://bot.letsvpn.bet/botWeb/options/", n);
			                   } catch (o) {
			                      l = null;
			                   }
			                   if (!Array.isArray(l)) {
			                   ...
			                   if (!Array.isArray(l)) {
			                      be.value = [];
			                      xe.value = null;
			                      "function" == typeof window.showBillLoadError && window.showBillLoadError("加载数据失败,请切换网络或稍后重试！");
			                      return;
			                   }
	                   // 处理返回的数据
	                   l = l.map((e) => {
	            ...
	            const Ee = async () => {
	                if (!xe.value)
	                    return;
	                "function" == typeof window.clearBillDomData && window.clearBillDomData();
	                "function" == typeof window.resetBillFilters && window.resetBillFilters();
	                de.value = !0;
                const t = {};
                t.id = xe.value,
                t.groupId = ve.id;
                ...
                n.params = t;
			                let l;
			                try {
			                    l = await e.get("https://bot.letsvpn.bet/botWeb/bill/", n);
			                } catch (o) {
			                    l = null;
			                }
			                if (!l || "object" != typeof l || Array.isArray(l)) {
			                    try {
			                        l = await e.get("https://api.letsvpn.bet/botWeb/bill/", n);
			                    } catch (fallbackError) {
			                        l = null;
			                    }
			                }
	                    ...
	                    Ce.value = e;
		                    de.value = !1;
		                    "function" == typeof window.updateBillFilterOptions && window.updateBillFilterOptions([]);
		                    "function" == typeof window.billDomDataChanged && window.billDomDataChanged();
		                    "function" == typeof window.showBillLoadError && window.showBillLoadError("账单明细加载失败,请切换网络或稍后重试！");
		                    return;
		                }
	                // console.log(l);
                ...
                if (l.bills) {
                    l.bills.reverse(),
                    Ce.value = l;
                    "function" == typeof window.updateBillFilterOptions && window.updateBillFilterOptions(l.bills);
                    "function" == typeof window.billDomDataChanged && window.billDomDataChanged()
                } else {
                    const e = {
                        totalInBase: 0,
...
if (checkbox2) checkbox2.addEventListener("click", function() {
