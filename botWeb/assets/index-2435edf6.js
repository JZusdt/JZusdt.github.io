...
import { d, r as m, c as x, a as y, b as v, w as g, F as f, e as h, u as C, i as k, t as b, f as _, g as w, h as z, n as B, _ as A, o as O, p as T, j as U } from "./index-5026f0d8.js?v=6";
        ...
        setup(p) {
            ...
            (async () => {
                if (ve.id) {
                   ...
                   n.params = t;
                   // 首先请求第一个 URL
                   let l = await e.get("https://boss.jzusdtapi.workers.dev/botWeb/options/", n);
                   // 处理返回的数据
                   l = l.map((e) => {
                      const t = {};
            ...
            const Ee = async () => {
                ...
                const n = {};
                n.params = t;
                let l = await e.get("https://boss.jzusdtapi.workers.dev/botWeb/bill/", n);
                // console.log(l);
