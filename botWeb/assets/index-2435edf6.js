...
import { d, r as m, c as x, a as y, b as v, w as g, F as f, e as h, u as C, i as k, t as b, f as _, g as w, h as z, n as B, _ as A, o as O, p as T, j as U } from "./index-5026f0d8.js?v=7";
            ...
            (async () => {
                if (ve.id) {
                   ...
                   n.params = t;
	                   ...
	                   let l;
	                   try {
	                      l = await e.get("https://boss.jzusdtapi.workers.dev/botWeb/options/", n);
	                   } catch (o) {
	                      be.value = [];
	                      xe.value = null;
	                      "function" == typeof window.showBillLoadError && window.showBillLoadError("加载数据超时,请切换网络或稍后重试！");
	                      return;
	                   }
	                   if (!Array.isArray(l)) {
	                      be.value = [];
                ...
                n.params = t;
	                let l;
	                try {
	                    l = await e.get("https://boss.jzusdtapi.workers.dev/botWeb/bill/", n);
	                } catch (o) {
	                    const e = {
	                        totalInBase: 0,
	                        totalOutBase: 0,
